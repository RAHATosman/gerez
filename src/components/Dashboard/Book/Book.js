...
const Book = () => {
    ...
    const { selectedService: { price, title } } = useContext(UserContext);
    ...
    return (
        ...
        <>
            ...
            <Toast className="toast-right" onClose={() => setShow(false)} delay={5000} show={show} autohide>
            ...
            <section>
                ...
                <Container className="p-5 mt-5 mx-auto bg-white" style={{ borderRadius: "15px" }}>

                    <div className="px-4">

                        <Row>

                            <Col className="pr-md-4" md={6} xs={12}>
                            ...
                            <Col className="pl-md-4 form-main" md={6} xs={12}>
