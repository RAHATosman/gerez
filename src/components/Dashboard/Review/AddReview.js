...
const AddReview = ({ review, setReview, edit, setEdit }) => {
    ...
    const onSubmit = data => {
        ...
        axios.post('https://gerez-server.herokuapp.com/addReview', data)
            ...
            .then(res => {
                ...
                swal("Failed!", "Something went wrong1! Please try again.", "error", { dangerMode: true });
            })
    ...
    return (
        ...
        <section>
            ...
            <Form className="w-100 form-main" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="p-5 mx-auto mt-5 bg-white" style={{ borderRadius: "15px", maxWidth: '50rem' }}>
                    ...
                    <div className="text-center mt-4">
                        ...
                        <Button className="btn-main" type="submit" style={{ padding: ".6rem 2rem" }}>
