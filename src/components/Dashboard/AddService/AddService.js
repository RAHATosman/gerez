...
const AddService = ({ restrictPermission, editService, setEditService }) => {
    ...
    return (
        <section className="add-service">
            ...
            <Form className="w-100" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="py-5 mx-auto bg-white mt-5 form-main" style={{maxWidth: '85rem' , borderRadius: "15px"}}>

                    <Form.Row className="justify-content-center">

                        <Form.Group className="mr-md-5" as={Col} md={5} sm={12}>
                        ...
                        <Form.Group className="mr-md-5 mt-md-3" as={Col} md={5} sm={12}>
                        ...
                        <Form.Group className="mt-md-3" as={Col} md={5} sm={12}>
