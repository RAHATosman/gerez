                ...
                <Row>
                    ...
                    <Col md={12} lg={4}>
                        ...
                        <div className="dk-footer-box-info">
                            ...
                            <Link to="/" className="footer-logo" onClick={scrollHandler} >
                            ...
                            <div className="footer-social-link">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <Link to="/" className="google-plus" onClick={scrollHandler}>
                                    ...
                                    <li>
                                        ...
                                        <Link to="/" className="linkedin" onClick={scrollHandler}>
                                    ...
                                    <li>
                                        ...
                                        <Link to="/" className="instagram" onClick={scrollHandler}>
